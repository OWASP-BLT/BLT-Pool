...
class AdminService:
    ...
    async def _ensure_tables(self) -> None:
        ...
        been moved to migrations/0000_initial_schema.sql.

        Apply migrations with:
            wrangler d1 migrations apply LEADERBOARD_DB

        This method is retained so that existing call-sites do not need to be
        updated, but it no longer issues any DDL at runtime.
        """
        # Nothing to do — schema is applied via Wrangler migrations.
        pass
